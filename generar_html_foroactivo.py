...
<head>
    ...
    <style>
        *, *::before, *::after {{
        ...
        .sidebar-disney-expand-li {{
            list-style: none;
            margin: 0 0 6px 0;
            padding: 0;
        }}
        
        .sidebar-disney-expand {{
...
<body>
                ...
                <ul class="sidebar-menu">
                    ...
                    <li id="disneySubWrap" class="sidebar-disney-expand-li" style="display: none;">
                        <div class="sidebar-disney-expand">
                            ...
                            <select id="disneySubFilter" class="filter-select" onchange="onDisneySubChange()">
    ...
    <script>
        ...
        function showTab(tab, btnElement) {{
            ...
            const disneyWrap = document.getElementById('disneySubWrap');
            if (disneyWrap) {{
